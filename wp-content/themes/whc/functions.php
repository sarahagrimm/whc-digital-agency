<?php
/**
 * whc-default functions and definitions
 *
...
if ( ! function_exists( 'whc_setup' ) ) :
	...
	function whc_setup() {
		 ...
		 * If you're building a theme based on whc-default, use a find and replace
		 * to change 'whc-default' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'whc-default' ),
			'primary' => __( 'Primary Menu', 'whc-default' )
		) );
...
function whc_scripts() {
	...
	// Enqueue Bootstrap End //
	
	// Enqueue Sass File //

	wp_enqueue_style('whc-sass', get_template_directory_uri() . '/sass/style.scss');

	// Enqueue Sass File End //
